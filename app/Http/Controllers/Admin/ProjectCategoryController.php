...
class ProjectCategoryController extends Controller
{
    ...
    {
        return Inertia::render('Admin/ProjectCategories/Create');
    }
    ...
    public function show(ProjectCategory $projectCategory): Response
    {
        ...
        return Inertia::render('Admin/ProjectCategories/Show', [
    ...
    {
        return Inertia::render('Admin/ProjectCategories/Edit', [
            'category' => $projectCategory,
        ]);
    }
