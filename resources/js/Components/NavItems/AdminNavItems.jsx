...
export const getAdminNavigationItems = () => {
    return [
        ...
        {
            name: "バーチャルオフィス",
            href: "admin.virtual-office.index",
            ...
            currentPath: "admin.virtual-office.*",
            children: [],
        },
        // Atlas（富裕層向けサービス）
        {
            name: "Atlas",
            href: "admin.atlas-membership.index",
            ...
            currentPath: ["admin.atlas-membership.*", "admin.atlas-invite-code.*"],
            children: [
                { name: "会員管理", href: "admin.atlas-membership.index" },
                { name: "招待コード管理", href: "admin.atlas-invite-code.index" },
            ],
        },
        // 各種データ管理
        {
        ...
        // スケジュール管理
        {
            ...
            currentPath: ["admin.schedules.*", "admin.task.*"],
            children: [
                {
                    name: "カレンダー",
                    href: "admin.schedules.index",
        ...
        // システム管理
        {
            ...
            currentPath: ["admin.systemSetting.*", "admin.mediaSettings.*"],
            children: [
                // { name: "システム設定", href: "admin.system.settings" },
                { name: "組織設定", href: "admin.organization.edit" },
                { name: "メディア設定", href: "admin.mediaSettings.edit" },
                {
                    name: "組織沿革",
