...
export const CreateButton = ({ children = "新規作成", ...props }) => {
    ...
    return (
        <BasicButton variant="success" icon={icon} {...props}>
            {children}
        </BasicButton>
    );
};
...
export const StoreButton = ({
    ...
    return (
        <BasicButton type={type} variant="primary" icon={icon} {...props}>
            {children}
        </BasicButton>
    );
};
...
export const ShowButton = ({ children = "詳細", ...props }) => {
    ...
    return (
        <BasicButton variant="info" icon={icon} {...props}>
            {children}
        </BasicButton>
    );
};
...
export const EditButton = ({ children = "編集", ...props }) => {
    ...
    return (
        <BasicButton variant="warning" icon={icon} {...props}>
            {children}
        </BasicButton>
    );
};
...
export const UpdateButton = ({ children = "更新", ...props }) => {
    ...
    return (
        <BasicButton variant="primary" icon={icon} {...props}>
            {children}
        </BasicButton>
    );
};
...
export const DeleteButton = ({ children = "削除", ...props }) => {
    ...
    return (
        <BasicButton variant="danger" icon={icon} {...props}>
            {children}
        </BasicButton>
    );
};
