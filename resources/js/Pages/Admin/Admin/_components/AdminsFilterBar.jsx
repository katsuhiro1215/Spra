...
const FILTER_FIELDS = [
    {
        ...
        placeholder: PageConfig.admins.filters.role.placeholder,
        options: ADMIN_ROLE_OPTIONS,
    },
    {
        key: "status",
        label: PageConfig.admins.filters.status.label,
        placeholder: PageConfig.admins.filters.status.placeholder,
            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-3">
                ...
                <div className="flex-1 max-w-md">
                    <SearchBar
                        ...
                        onSearch={onSearch}
                        placeholder={PageConfig.admins.ui.search.placeholder}
