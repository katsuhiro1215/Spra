...
export default function CreateException({ auth }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("admin.schedules.exceptions.store"));
    };
    ...
    const breadcrumbs = [
        ...
        PageConfig.exceptions.pages.create.breadcrumb,
    ];
    ...
    return (
        <AdminAuthenticatedLayout
            header={
                <PageHeader
                    title={PageConfig.exceptions.pages.create.title}
                    description={PageConfig.exceptions.pages.create.description}
