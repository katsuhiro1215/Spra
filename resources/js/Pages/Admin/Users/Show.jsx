...
export default function Show({ user, mediaList = [], projectInquiries = [] }) {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <div className="sm:col-span-2 lg:col-span-3 space-y-6">
                    ...
                    <Card>
                        ...
                        <CardBody>
                            {projectInquiries && projectInquiries.length > 0 ? (
                                <div className="space-y-4">
                                        ...
                                        >
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                                                ...
                                                {inquiry.estimated_price && (
                                                    <div className="flex items-start gap-2">
                                                        <CurrencyYenIcon className="w-4 h-4 text-gray-400 mt-0.5 flex-shrink-0" />
                                                        <div>
                                                            <p className="text-xs text-gray-500">
                                                                概算金額
                                                            </p>
