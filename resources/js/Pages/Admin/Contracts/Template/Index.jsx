...
import ContractTemplateTable from "./_components/ContractTemplateTable";
...
export default function Index({ templates, filters = {}, stats }) {
    ...
    // ========================================
    const handleSearch = () => {
        get(route("admin.contract.template.index"), {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    const handleDelete = (template) => {
        ...
        if (confirmed) {
            router.delete(route("admin.contract.template.destroy", template.id));
        }
    };
    ...
    const headerActions = [
        {
            label: PageConfig.contractTemplates.actions.create,
            icon: PlusIcon,
            variant: "primary",
            route: route("admin.contract.template.create"),
        },
    ];
    ...
    const tabs = [
        {
            key: "with_trashed",
            label: PageConfig.contractTemplates.ui.tabs.all,
            count: stats?.all || templates.total,
        },
        {
            key: "without_trashed",
            label: PageConfig.contractTemplates.ui.tabs.list,
            count: stats?.active || templates.total,
        },
        {
            key: "only_trashed",
            label: PageConfig.contractTemplates.ui.tabs.trashed,
    ...
    return (
        <AdminAuthenticatedLayout
            header={
                <PageHeader
                    title={PageConfig.contractTemplates.title}
                    description={PageConfig.contractTemplates.description}
                    actions={headerActions}
                    breadcrumbs={PageConfig.contractTemplates.breadcrumbs}
                />
            }
        >
            <Head title={PageConfig.contractTemplates.documentTitle} />
                ...
                <div className="flex flex-col lg:flex-row lg:items-center gap-3">
                    ...
                    <div className="flex-1 max-w-md">
                        <SearchBar
                            ...
                            placeholder={
                                PageConfig.contractTemplates.ui.search
                                    .placeholder
                            }
                            disabled={processing}
                        />
                    ...
                    <div className="flex-shrink-0">
                        ...
                        >
                            ...
                            {
                                PageConfig.contractTemplates.ui.filter
                                    .button
                            }
                            {activeFilterCount > 0 && (
                ...
                {showFilters && (
                    <div className="pt-3 border-t border-slate-200 dark:border-slate-700">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                            ...
                            <FilterSelect
                                label={
                                    PageConfig.contractTemplates.filters
                                        .status.label
                                }
                            ...
                            <div className="flex items-end">
                                ...
                                >
                                    ...
                                    {
                                        PageConfig.contractTemplates.ui
                                            .filter.clear
                                    }
                                </SecondaryButton>
                            </div>
