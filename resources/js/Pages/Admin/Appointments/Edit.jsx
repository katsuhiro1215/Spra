...
export default function Edit({
    ...
    const [filteredProjects, setFilteredProjects] = useState(
        appointment.company_id
            ? projects.filter((p) => p.company_id === appointment.company_id)
            : projects,
    );
    ...
    const breadcrumbs = [
        ...
        PageConfig.appointments.pages.edit.breadcrumb,
    ];
    ...
    return (
        <AdminAuthenticatedLayout
            header={
                <PageHeader
                    title={PageConfig.appointments.pages.edit.title}
                    description={PageConfig.appointments.pages.edit.description}
                    actions={headerActions}
                    breadcrumbs={breadcrumbs}
                />
            }
        >
            <Head title={PageConfig.appointments.pages.edit.title} />
