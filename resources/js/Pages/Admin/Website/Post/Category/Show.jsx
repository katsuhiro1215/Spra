...
const BlogCategoryShow = ({ category }) => {
        ...
        if (
            ...
            router.delete(
                route("admin.website.blog.category.destroy", category.id),
                {
                    onSuccess: () =>
                        router.get(
                            route("admin.website.blog.category.index")
                        ),
                }
            );
        }
    ...
    const headerActions = [
        {
            label: PageConfig.blogCategories.actions.back,
            icon: ArrowLeftIcon,
            variant: "secondary",
            route: route("admin.website.blog.category.index"),
        },
    ];
    ...
    return (
        <AdminAuthenticatedLayout>
            ...
            {/* ヘッダー */}
            <PageHeader
                title={PageConfig.blogCategories.pages.create.title}
