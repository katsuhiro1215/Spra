...
export default function Create() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("admin.website.siteSetting.store"));
    };
    ...
    return (
        <AdminAuthenticatedLayout
            header={
                <PageHeader
                    title={PageConfig.siteSettings.pages.create.title}
                    description={PageConfig.siteSettings.pages.create.description}
                    actions={[
                        {
                            label: "サイト設定一覧",
                            icon: ArrowLeftIcon,
                    ...
                    breadcrumbs={[
                        ...
                        PageConfig.siteSettings.pages.create.breadcrumb,
                    ]}
                />
            }
        >
