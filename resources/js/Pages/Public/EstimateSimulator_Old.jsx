...
import { estimateQuestions as defaultQuestions } from "@/Data/estimateQuestions";
...
export default function EstimateSimulator({
    ...
    // 質問データ: propsから渡された場合は使用、なければデフォルト
    const estimateQuestions = questions || defaultQuestions;
