...
export default function AdminSidebar({ sidebarOpen, setSidebarOpen }) {
    ...
    const navigationItems = [
        ...
        },
        {
            ...
            children: [
                { name: "記事管理", href: "admin.content.posts" },
                { name: "カテゴリ", href: "admin.content.categories" },
                { name: "メディア", href: "admin.content.media" }
            ]
        },
        {
            name: "設定",
            ...
            children: [
                { name: "一般設定", href: "admin.settings.general" },
                { name: "セキュリティ", href: "admin.settings.security" },
                { name: "システム", href: "admin.settings.system" }
            ]
        }
    ];
                        ...
                        {navigationItems.map((item, index) => (
                            ...
                            >
                                ...
                                {item.children && item.children.length > 0 && hoveredItem === index && (
                                    <div 
                                        className="absolute left-full top-0 ml-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50 animate-in slide-in-from-left-2 duration-200"
                                        onMouseEnter={() => handleMouseEnter(index)}
                                        onMouseLeave={handleMouseLeave}
                                    >
